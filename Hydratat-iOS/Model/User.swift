...
struct User {
    ...
    static var allCases: [User] = [
        User(avatar: Avatar(color1: "orange", color2: "purple"), name: "Flo", age: 28, email: "flo@gmail.com", height: 179, weight: 71, drinking_objectif: 1500,
             quantites: [Quantity(type_quantity: .Bottle, content: 2000, date: .init(timeInterval: -86400, since: .now)) ]),
        User(avatar: Avatar(color1: "blue", color2: "green"), name: "Justin", age: 28, email: "justin@gmail.com", height: 175, weight: 65, drinking_objectif: 1000,
             quantites: [Quantity(type_quantity: .Bottle, content: 500, date: .init(timeInterval: -86400, since: .now)),
                         Quantity(type_quantity: .Can, content: 500, date: .init(timeInterval: -86400, since: .now))]),
        User(avatar: Avatar(color1: "red", color2: "orange"), name: "David", age: 28, email: "david@gmail.com", height: 178, weight: 68, drinking_objectif: 1000,
             quantites: [Quantity(type_quantity: .Glass, content: 150, date: .init(timeInterval: -86400, since: .now)),
                         Quantity(type_quantity: .Bottle, content: 1000, date: .init(timeInterval: -86400, since: .now))])
    ]
